      ...
      >
        ...
        <div className="mt-5">
          <button
            ...
            className="w-full py-3 rounded-md text-sm font-medium transition bg-gray-900 text-white hover:opacity-90 disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed"
          >
